...
public class IntDataContainer extends DataContainer {
    ...
    public IntVector vec = null;

    public IntDataContainer(String chanNameI, RootAllocator allocatorI) throws Exception {
        super(chanNameI,CT2Plasma.DataType.INT_DATA);
